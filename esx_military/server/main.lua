...
RegisterServerEvent('esx_militaryjob:confiscatePlayerItem')
AddEventHandler('esx_militaryjob:confiscatePlayerItem', function(target, itemType, itemName, amount)
	...
	if sourceXPlayer.job.name ~= 'military' then
		print(('esx_militaryjob: %s attempted to confiscate!'):format(xPlayer.identifier))
		return
	end
...
RegisterServerEvent('esx_militaryjob:handcuff')
...
RegisterServerEvent('esx_militaryjob:drag')
...
RegisterServerEvent('esx_militaryjob:putInVehicle')
...
RegisterServerEvent('esx_militaryjob:OutVehicle')
...
RegisterServerEvent('esx_militaryjob:getStockItem')
...
RegisterServerEvent('esx_militaryjob:putStockItems')
...
ESX.RegisterServerCallback('esx_militaryjob:getOtherPlayerData', function(source, cb, target)
...
ESX.RegisterServerCallback('esx_militaryjob:getVehicleFromPlate', function(source, cb, plate)
	MySQL.Async.fetchAll('SELECT owner FROM owned_vehicles WHERE plate = @plate', {
		['@plate'] = plate
	}, function(result)
...
AddEventHandler('playerDropped', function()
	...
	if _source ~= nil then
		...
		if xPlayer ~= nil and xPlayer.job ~= nil and xPlayer.job.name == 'military' then
			Citizen.Wait(5000)
...
RegisterServerEvent('esx_militaryjob:spawned')
...
RegisterServerEvent('esx_militaryjob:forceBlip')
...
RegisterServerEvent('esx_militaryjob:message')
AddEventHandler('esx_militaryjob:message', function(target, msg)
